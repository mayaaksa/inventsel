...
<head>
    ...
    <title>Reset Password | InvenTsel</title>
    ...
    <div class="w-full max-w-lg text-center">
        ...
        <div class="bg-white/60 backdrop-blur-2xl border border-white/50 p-10 rounded-[32px] shadow-xl text-left">
            <div class="text-center mb-8">
                <h2 class="text-xl font-bold text-slate-800">Atur Password Baru</h2>
                <p class="text-slate-500 text-xs mt-2 px-4 leading-relaxed">
                    Masukkan email dan password baru kamu untuk mereset akses.
                </p>
            </div>
            ...
            <form method="POST" action="{{ route('password.store') }}" class="space-y-5">
                ...
                <div>
                    <label class="block text-[10px] font-bold text-slate-700 mb-2 ml-1 uppercase tracking-wider">Email</label>
                ...
                <div>
                    <label class="block text-[10px] font-bold text-slate-700 mb-2 ml-1 uppercase tracking-wider">Password Baru</label>
                ...
                <div>
                    <label class="block text-[10px] font-bold text-slate-700 mb-2 ml-1 uppercase tracking-wider">Konfirmasi Password</label>
